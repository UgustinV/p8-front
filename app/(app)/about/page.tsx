...
export default function AboutPage() {
    return (
        <div className="flex flex-col items-center gap-10 my-10 mx-40">
            <section className="flex flex-col items-center gap-5 w-full">
                ...
                <Image src="/about-heading-image.png" alt="À propos de Kasa" width={1152} height={648} className="w-full max-h-115 object-cover rounded-[20px] mt-5" />
            </section>
            <section className="flex flex-row gap-4">
                <div className="flex flex-col gap-4 w-5/9 py-28">
                ...
                <Image src="/about-content-image.png" alt="Notre mission" width={600} height={400} className="object-cover rounded-[20px] w-4/9" />
            </section>
        </div>
    );
}